...
class CommentCreateView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        send_mail(
            ...
            message=f"Здравствуйте, {comment.post.author}. Посмотреть отклик: http://127.0.0.1:8000/",
            from_email="admnforskillf@gmail.com",
...
def confirm_comment(request, **kwargs):
    if request.user.is_authenticated:
        ...
        send_mail(
            ...
            message=f"Здравствуйте, {comment.author}, Автор объявления {comment.post.title} принял Ваш отклик:http://127.0.0.1:8000/posts/comments",
            from_email="admnforskillf@gmail.com",
            recipient_list=[
...
class EmailVerificationView(TemplateView):
    template_name = "usersapp/email_verification.html"
